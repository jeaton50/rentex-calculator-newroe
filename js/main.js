...
window.generateAllEquipment = function () {
  ...
  let totalPixelCount = 0; // sum of each screen's (H × V)
  ...
  window.screenConfigurations.forEach((config, index) => {
    ...
    totalPixelCount += screenPixelsH * screenPixelsV;
    ...
    summaryContentDiv.innerHTML = `
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
        ...
        <div class="pixel-summary">
          <h4 style="margin-top: 0;">Total Screen Pixels</h4>
          <div><strong>Total Pixels:</strong> ${(totalPixelCount || 0).toLocaleString()} px</div>
    ...
    if (summaryContentDiv) {
      summaryContentDiv.innerHTML = `
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
          ...
          <div class="pixel-summary">
            <h4 style="margin-top: 0;">Total Screen Pixels <span style="color: #007bff; font-size: 0.85em;">(Single Room)</span></h4>
            <div><strong>Total Pixels:</strong> ${(totalPixelsHorizontal * totalPixelsVertical || 0).toLocaleString()} px</div>
            <div><strong>Horizontal:</strong> ${(totalPixelsHorizontal || 0).toLocaleString()} px</div>
            <div><strong>Vertical:</strong> ${(totalPixelsVertical || 0).toLocaleString()} px</div>
          </div>
          <div class="weight-summary">
  ...
  combinedTotalsBlock.innerHTML = `
    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
      <div>
        <h4 style="margin: 0 0 5px 0;">Total Screen Pixels${singleRoomLabel}</h4>
        <div><strong>Total Pixels:</strong> ${(window.screenCombineMode === 'single' ? totalPixelsHorizontal * totalPixelsVertical : totalPixelCount || 0).toLocaleString()} px</div>
        <div><strong>Horizontal:</strong> ${(totalPixelsHorizontal || 0).toLocaleString()} px</div>
        <div><strong>Vertical:</strong> ${(totalPixelsVertical || 0).toLocaleString()} px</div>
      </div>
      <div>
